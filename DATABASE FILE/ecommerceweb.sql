...
CREATE TABLE `tbl_settings` (
  ...
  `total_recent_post_footer` SMALLINT NOT NULL,
  `total_popular_post_footer` SMALLINT NOT NULL,
  `total_recent_post_sidebar` SMALLINT NOT NULL,
  `total_popular_post_sidebar` SMALLINT NOT NULL,
  `total_featured_product_home` SMALLINT NOT NULL,
  `total_latest_product_home` SMALLINT NOT NULL,
  `total_popular_product_home` SMALLINT NOT NULL,
  `meta_title_home` VARCHAR(191) NOT NULL,
  ...
  `home_service_on_off` TINYINT(1) NOT NULL,
  `home_welcome_on_off` TINYINT(1) NOT NULL,
  `home_featured_product_on_off` TINYINT(1) NOT NULL,
  `home_latest_product_on_off` TINYINT(1) NOT NULL,
  `home_popular_product_on_off` TINYINT(1) NOT NULL,
  `home_testimonial_on_off` TINYINT(1) NOT NULL,
  `home_blog_on_off` TINYINT(1) NOT NULL,
  `newsletter_on_off` TINYINT(1) NOT NULL,
  `ads_above_welcome_on_off` TINYINT(1) NOT NULL,
  `ads_above_featured_product_on_off` TINYINT(1) NOT NULL,
  `ads_above_latest_product_on_off` TINYINT(1) NOT NULL,
  `ads_above_popular_product_on_off` TINYINT(1) NOT NULL,
  `ads_above_testimonial_on_off` TINYINT(1) NOT NULL,
  `ads_category_sidebar_on_off` TINYINT(1) NOT NULL,
  PRIMARY KEY (`id`)
